...
!function($){
  ...
  $.fn.let_it_snow = function(options){
    ...
    function reset(flake) {
        ...
        flake.speed = (Math.random() * 0.6) + settings.speed;
        flake.velY = flake.speed;
        flake.velX = 0;
        flake.opacity = (Math.random() * 0.9) + settings.opacity;
    }
     function init() {
      for (var i = 0; i < flakeCount; i++) {
          var x = Math.floor(Math.random() * canvas.width),
              ...
              speed = (Math.random() * 0.6) + settings.speed,
              opacity = (Math.random() * 0.9) + settings.opacity;
